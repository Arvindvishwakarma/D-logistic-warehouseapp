import { View, Text ,StatusBar, ScrollView, TouchableOpacity, TextInput,Linking,ActivityIndicator,Image} from 'react-native'
...
export default function AllQRInvoice({navigation}) {
        ...
        <View style={{ backgroundColor: "#3498DB", height: 200, borderBottomLeftRadius: 30, borderBottomRightRadius: 30 }}>
            ...
            <View style={{ flexDirection: "column", justifyContent: "center", alignItems: "center", marginTop: 70 }}>
                <View style={{ flexDirection: "row", width: "90%" }}>
                    ...
                    <Text style={{ fontSize: 18, fontFamily: "Poppins-SemiBold", color: "#fff", marginLeft: 10 }}>Print QR </Text>
                </View>
            </View>
        </View>
        ...
        <View style={{ flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
            {
                      ...
                      :
                      data && data.getAllInvoice.length === 0 ?
                          ...
                          <Card style={{ width: "90%", height: 100, marginTop: 10, marginBottom: 10, elevation: 5, borderRadius: 10 }}>
                              <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between" }}>
                                  <View style={{ width: "50%" }}>
                                      ...
                                      <View style={{ flexDirection: "row", marginLeft: 10,width:"90%" ,marginBottom:10}}>
                                  ...
                                  <View style={{ width: "50%" }}>
                                      <Text style={{ marginLeft: 10, color: "#34495E", fontSize: 9, marginTop: 7, fontFamily: "Poppins-SemiBold" }}><Moment element={Text} format='DD MMM YYYY'>{item.createdDateTime}</Moment> , <Moment element={Text} format='hh:mm A'>{item.createdDateTime}</Moment> </Text>
                                      ...
                                      <View style={{ flexDirection: "column", width: "60%", justifyContent: "center", alignItems: "center", backgroundColor: "#1ABC9C", marginLeft: 10, height: 25, borderRadius: 50, marginTop: 1 }}>
                                          <TouchableOpacity onPress={() => Linking.openURL(`https://rad-cobbler-126e60.netlify.app/printQR/${item.id}`)}>
                                              <View style={{ width: "70%", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                                                  <Text style={{ color: "#fff", fontSize: 12 }}>Print QR</Text>
                                              </View>
                                          </TouchableOpacity>
                                      </View>
                                  </View>
                          ...
                          <Card style={{ width: "90%", height: 100, marginTop: 10, marginBottom: 10, elevation: 5, borderRadius: 10 }}>
                              <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between" }}>
                                  <View style={{ width: "50%" }}>
                                      ...
                                      <View style={{ flexDirection: "row", marginLeft: 10,width:"90%",mar }}>
                                          <Text style={{ fontSize: 9, fontFamily: "Poppins-SemiBold", color: "#2980B9",marginBottom:10 }}>Phone : </Text>
                                          <Text style={{ fontSize: 9, fontFamily: "Poppins-SemiBold", color: "#34495E" }}>{item.phoneOne} </Text>
                                      </View>
